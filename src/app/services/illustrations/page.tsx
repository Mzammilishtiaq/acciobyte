...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <PageHeader title={"Illustrations"} subtitle1={"Home"} subtitle2={"services"} classsubtitle2={""} subtitle3={"illustrations"} classsubtitle3={"text-lime-400"} star={"*"}/>
        ...
        <div className="md:col-span-3 flex flex-col gap-8">
          ...
          <div className=" rounded-xl p-6 mb-10">
            ...
            <div className="flex flex-col lg:flex-col gap-6 items-center mb-8">
              <img
                src="https://www.acciobyte.com/_next/static/media/sec1.d2123dfe.png"
                alt="Web Dev Hero"
                className="rounded-lg w-full  h-[50vh] lg:h-[70vh] object-cover"
              />
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center">
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/main.28557fac.jpg"
                  alt="Features"
                  className="rounded-lg w-full md:w-[50%] h-60 object-cover"
                />
              </div>
            </div>
            {/* Process Section */}
            ...
            <div className="flex flex-col justify-center gap-6 mb-10">
              ...
              >
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/step1.80f7b475.jpg"
              ...
              <motion.div
                whileHover={{ scale: 1.03 }}
                className="flex items-start md:flex-row rounded-xl p-6 shadow-lg gap-6"
              >
                <img
              ...
              >
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/step3.d9148d2c.jpg"
                  alt="Planning & Strategy"
                  className="rounded-lg w-full md:w-1/2 h-64 object-cover"
                />
              </motion.div>
