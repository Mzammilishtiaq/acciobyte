      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 md:gap-8">
        ...
        <div className="lg:col-span-3 flex flex-col gap-6 md:gap-8">
          ...
          <div className="rounded-xl p-4 sm:p-6 mb-6 md:mb-10">
            {/* Hero Image & Intro */}
            <div className="flex flex-col lg:flex-col gap-4 sm:gap-6 items-center mb-6 md:mb-8">
              <img
                src="https://www.acciobyte.com/_next/static/media/sec1.addd3c5a.jpg"
                alt="Web Dev Hero"
            ...
            <div className="mb-6 md:mb-8">
              ...
              <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 items-center">
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/main.393f7b2c.jpg"
                  alt="Features"
            ...
            <div className="flex flex-col items-center justify-center gap-4 sm:gap-6 mb-8 md:mb-10">
              ...
              >
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/step1.46e27a0f.jpg"
              ...
              >
                <img
                  src="https://www.acciobyte.com/_next/static/media/step2.5f381c9f.jpg"
                  alt="Planning & Strategy"
              ...
              >
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/step3.9f0fa555.jpg"
                  alt="Planning & Strategy"
                  className="rounded-lg w-full lg:w-[40%] h-48 sm:h-56 md:h-64 object-cover"
                />
              </motion.div>
