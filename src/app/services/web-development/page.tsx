...
<PageHeader title={"Web Development"} subtitle1={"Home"} subtitle2={"services"} classsubtitle2={""} subtitle3={"web-development"} classsubtitle3={"text-lime-400"} star={"*"}/>
        ...
        <div className="md:col-span-3 flex flex-col gap-8">
          ...
          <div className=" rounded-xl p-6 mb-10">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-center mb-8">
              <img
                src="https://www.acciobyte.com/_next/static/media/sec1.b627f3b3.jpg"
                alt="Web Dev Hero"
                className="rounded-lg  h-[70vh] w-full md:w-1/2 object-cover"
              />
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center">
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/main.1a9eef42.jpg"
                  alt="Features"
            ...
            <div className="flex flex-col items-center justify-center gap-6 mb-10">
              ...
              >
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/step1.e543bf87.jpg"
              ...
              >
                <img
                  src="https://www.acciobyte.com/_next/static/media/step2.12f8307f.jpg"
                  alt="Planning & Strategy"
                  className="rounded-lg w-full md:w-[40%] h-64 object-cover"
                />
