...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <PageHeader title={"Graphic Designer"} subtitle1={"Home"} subtitle2={"services"} classsubtitle2={""} subtitle3={"graphic-designer"} classsubtitle3={"text-lime-400"} star={"*"}/>
      <div className=" bg-lime-400 py-2 sm:py-4 z-10 overflow-hidden">
        <motion.div
          className="flex whitespace-nowrap"
          animate={{ x: [0, -1000] }}
          transition={{ x: { repeat: Number.POSITIVE_INFINITY, repeatType: "loop", duration: 20, ease: "linear" } }}
        >
          <div className="flex items-center space-x-4 sm:space-x-8 text-black font-bold text-xs xs:text-sm sm:text-base md:text-xl">
      ...
      <div className="pt-32 pb-20 px-2 xs:px-4 md:px-8 lg:px-16">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
        {/* Left: Steps and FAQ */}
        <div className="md:col-span-3 flex flex-col gap-6 md:gap-8">
          {/* Steps Section */}
          {/* Web Development Hero & Features Section */}
          <div className="rounded-xl p-2 xs:p-4 md:p-6 mb-6 md:mb-10">
            {/* Hero Image & Intro */}
            <div className="flex flex-col md:flex-col lg:flex-col gap-4 md:gap-6 items-center mb-6 md:mb-8">
              <img
                src="https://www.acciobyte.com/_next/static/media/sec1.e8ec9b83.jpg"
                alt="Web Dev Hero"
                className="rounded-lg w-full md:w-1/2 lg:w-full h-48 xs:h-60 md:h-[70vh] object-cover"
              />
              <div className="flex-1 w-full">
                <p className="text-gray-300 text-xs xs:text-sm mb-2">
            ...
            <div className="mb-6 md:mb-8">
              <h2 className="text-xl xs:text-2xl md:text-3xl font-bold mb-2 text-white">
                Key <span className="text-lime-400">features</span> of website
                development
              </h2>
              <p className="text-gray-300 text-xs xs:text-sm mb-4">
              ...
              <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-center">
                <ul className="flex-1 space-y-2 text-xs xs:text-sm text-gray-200">
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/main.8c9f6fbb.jpg"
                  alt="Features"
                  className="rounded-lg w-full md:w-1/2 h-32 xs:h-40 md:h-60 object-cover"
                />
              </div>
            </div>
            {/* Process Section */}
            <div>
              ...
              <p className="text-gray-300 text-xs xs:text-sm mb-4 md:mb-6">
            ...
            <div className="flex flex-col items-center justify-center gap-4 md:gap-6 mb-6 md:mb-10">
              {/* Step 1 */}
              <motion.div
                whileHover={{ scale: 1.03 }}
                className="flex flex-col md:flex-row rounded-xl p-4 md:p-6 shadow-lg items-center gap-4 md:gap-6 w-full"
              >
                <div className="flex items-center justify-center bg-[#232323] rounded-2xl w-full md:w-[40%] h-40 xs:h-52 md:h-64 px-2 xs:px-5 py-2 xs:py-5">
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/step1.fe4ef8ea.jpg"
                  alt="Planning & Strategy"
                  className="rounded-lg w-full md:w-[40%] h-40 xs:h-52 md:h-64 object-cover"
                />
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.03 }}
                className="flex flex-col md:flex-row-reverse rounded-xl p-4 md:p-6 shadow-lg items-center gap-4 md:gap-6 w-full"
              >
                <img
                  src="https://www.acciobyte.com/_next/static/media/step2.102fe844.jpg"
                  alt="Planning & Strategy"
                  className="rounded-lg w-full md:w-[40%] h-40 xs:h-52 md:h-64 object-cover"
                />
                <div className="bg-[#232323] rounded-2xl w-full md:w-[40%] h-40 xs:h-52 md:h-64 px-2 xs:px-5 py-2 xs:py-5">
                  <div className="flex flex-col">
                    <div className="flex items-center justify-between gap-x-20 ">
                      <span className="p-2 rounded-full">
                        <svg
              ...
              >
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/step3.7d08c5fb.jpg"
                  alt="Planning & Strategy"
                  className="rounded-lg w-full md:w-[40%] h-40 xs:h-52 md:h-64 object-cover"
                />
              </motion.div>
          ...
          <div className="mt-6 md:mt-10">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 md:mb-6 text-lime-400">
              Lets address your questions today!
            </h2>
            <div className="space-y-2 xs:space-y-4">
              {/* FAQ Item 1 */}
              <motion.div
                className="bg-[#181818] rounded-lg p-3 xs:p-4 cursor-pointer"
                whileTap={{ scale: 0.98 }}
                onClick={() => setFaqOpen((prev) => !prev)}
              >
                <div className="flex justify-between items-center">
                  <span className="text-xs xs:text-sm">How long does it take to develop a website?</span>
                  <span className="text-lime-400 text-lg xs:text-xl transition-transform duration-200">
                    {faqOpen ? "−" : "+"}
                  </span>
                </div>
                {faqOpen && (
                  <div className="mt-2 text-gray-400 text-xs xs:text-sm">
        ...
        <div className="flex flex-col gap-6 md:gap-8 mt-8 md:mt-0">
          ...
          <div className="bg-[#181818] rounded-xl p-4 xs:p-6 shadow-lg">
            <h3 className="text-base xs:text-lg font-bold mb-2 xs:mb-4">Services Category</h3>
          ...
          {/* Contact Card */}
          <div className="bg-[#181818] rounded-xl p-4 xs:p-6 flex flex-col items-center text-center shadow-lg">
            <MessageSquare className="text-lime-400 w-8 h-8 xs:w-10 xs:h-10 mb-2" />
            <h4 className="font-bold mb-1 xs:mb-2 text-sm xs:text-base">You have different questions?</h4>
            <p className="text-gray-400 mb-2 xs:mb-4 text-xs xs:text-sm">
              Our team is available to answer all your questions.
            </p>
            <a
              href="tel:+20106565314"
              className="bg-lime-400 text-black font-bold px-4 xs:px-6 py-2 rounded-full hover:bg-lime-500 transition text-xs xs:text-base"
            >
              (20) 1065-65314
            </a>
          </div>
