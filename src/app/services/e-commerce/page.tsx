...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <PageHeader title={"E-commerce"} subtitle1={"Home"} subtitle2={"services"} classsubtitle2={""} subtitle3={"ecommmmerce"} classsubtitle3={"text-lime-400"} star={"*"}/>
        ...
        <div className="md:col-span-3 flex flex-col gap-8">
          ...
          <div className=" rounded-xl p-6 mb-10">
            ...
            <div className="flex flex-col md:flex-col gap-6 items-center mb-8">
              <img
                src="https://www.acciobyte.com/_next/static/media/sec1.45b345b4.jpg"
                alt="Web Dev Hero"
                className="rounded-lg h-[70vh] lg:w-full md:w-1/2 object-cover"
              />
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center">
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/main.5747116a.jpg"
                  alt="Features"
            ...
            <div className="flex flex-col items-center justify-center gap-6 mb-10">
              ...
              >
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/step1.32b871b1.jpg"
              ...
              <motion.div
                whileHover={{ scale: 1.03 }}
                className="flex flex-col md:flex-row items-start rounded-xl p-6 shadow-lg gap-6"
              >
                <img
                  src="https://www.acciobyte.com/_next/static/media/step2.bf76bec8.jpg"
                  alt="Planning & Strategy"
                  className="rounded-lg w-full md:w-[40%] h-64 object-cover"
                />
              ...
              >
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/step3.ad3d28f7.jpg"
                  alt="Planning & Strategy"
                  className="rounded-lg w-full md:w-[40%] h-64 object-cover"
                />
              </motion.div>
