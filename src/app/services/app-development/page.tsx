        ...
        <div className="md:col-span-3 flex flex-col gap-8">
          ...
          <div className=" rounded-xl p-6 mb-10">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-center mb-8">
              <img
                src="https://www.acciobyte.com/_next/static/media/sec1.49265124.jpg"
                alt="Web Dev Hero"
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center">
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/main.36f1a71d.jpg"
                  alt="Features"
            ...
            <div className="flex flex-col items-center justify-center gap-6 mb-10">
              ...
              >
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/step1.01221561.jpg"
              ...
              >
                <img
                  src="https://www.acciobyte.com/_next/static/media/step2.ca6faee4.jpg"
                  alt="Planning & Strategy"
                  className="rounded-lg w-full md:w-[40%] h-64 object-cover"
                />
              ...
              >
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/step3.b626e828.jpg"
                  alt="Planning & Strategy"
                  className="rounded-lg w-full md:w-[40%] h-64 object-cover"
                />
              </motion.div>
