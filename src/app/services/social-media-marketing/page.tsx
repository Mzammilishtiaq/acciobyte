...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <PageHeader title={"Social Media Marketing"} subtitle1={"Home"} subtitle2={"services"} classsubtitle2={""} subtitle3={"social-media-marketing"} classsubtitle3={"text-lime-400"} star={"*"}/>
      ...
      <div className="py-20 md:py-32 lg:py-40 px-4 md:px-16">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-3 flex flex-col gap-8">
          ...
          <div className=" rounded-xl p-6 mb-10">
            {/* Hero Image & Intro */}
            <div className="flex flex-col lg:flex-col gap-6 items-center mb-8">
              <img
                src="https://www.acciobyte.com/_next/static/media/sec1.7ad2c74c.jpg"
                alt="Web Dev Hero"
                className="rounded-lg h-[40vh] md:h-[50vh] lg:h-[70vh] w-full object-cover"
              />
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center">
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/step1.335a458a.jpg"
                  alt="Features"
            ...
            <div className="flex flex-col items-center justify-center gap-6 mb-10">
              ...
              >
                <div className="flex items-center justify-center bg-[#232323] rounded-2xl w-full md:w-1/2 h-64 px-5 py-5">
                  <div className="flex flex-col">
                    <div className="flex items-center justify-between lg:gap-x-20 ">
                    ...
                    <div className="flex flex-col lg:gap-y-5 lg:mt-5">
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/step2.e37e4801.jpg"
              ...
              <motion.div
                whileHover={{ scale: 1.03 }}
                className="flex items-start md:flex-row flex-col lg:flex-row rounded-xl p-6 shadow-lg gap-6"
              >
                <img
                  src="https://www.acciobyte.com/_next/static/media/step2.e37e4801.jpg"
                  alt="Planning & Strategy"
                  className="rounded-lg w-full md:w-1/2 h-64 object-cover"
                />
                <div className=" bg-[#232323] rounded-2xl w-full md:w-1/2 h-64 px-5 py-5">
                  <div className="flex flex-col">
              ...
              >
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/step3.4dfeae5d.jpg"
                  alt="Planning & Strategy"
                  className="rounded-lg w-full md:w-1/2 h-64 object-cover"
                />
              </motion.div>
