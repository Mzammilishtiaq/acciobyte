...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <PageHeader title={"Video Animation"} subtitle1={"Home"} subtitle2={"services"} classsubtitle2={""} subtitle3={"video-animation"} classsubtitle3={"text-lime-400"} star={""}/>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 sm:gap-8">
        ...
        <div className="lg:col-span-3 flex flex-col gap-6 sm:gap-8">
          ...
          <div className="rounded-xl p-4 sm:p-6 mb-6 sm:mb-10">
            {/* Hero Image & Intro */}
            <div className="flex flex-col lg:flex-col gap-4 sm:gap-6 items-center mb-6 sm:mb-8">
              <img
                src="https://www.acciobyte.com/_next/static/media/sec1.0c91c707.jpg"
                alt="Web Dev Hero"
              ...
              <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 items-center">
                <ul className="flex-1 space-y-2 text-sm text-gray-200">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="text-lime-400 w-4 h-4 sm:w-5 sm:h-5" /> Custom
                    solutions for your business.
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="text-lime-400 w-4 h-4 sm:w-5 sm:h-5" /> Fully
                    responsive across all devices.
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="text-lime-400 w-4 h-4 sm:w-5 sm:h-5" /> Smooth and
                    modern user experience.
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="text-lime-400 w-4 h-4 sm:w-5 sm:h-5" />{" "}
                    SEO-optimized for better ranking.
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="text-lime-400 w-4 h-4 sm:w-5 sm:h-5" /> Fast,
                    secure, and reliable performance.
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="text-lime-400 w-4 h-4 sm:w-5 sm:h-5" /> Easy
                    content management with CMS.
                  </li>
                </ul>
                <img
                  src="https://www.acciobyte.com/_next/static/media/main.42e65858.jpg"
                  alt="Features"
                  className="rounded-lg w-full lg:w-[50%] h-48 sm:h-60 object-cover"
                />
              </div>
            </div>
            {/* Process Section */}
            ...
            <div className="flex flex-col items-center justify-center gap-4 sm:gap-6 mb-8 sm:mb-10">
              {/* Step 1 */}
              <motion.div
              ...
              >
                <div className="flex items-center justify-center bg-[#232323] rounded-2xl w-full lg:w-[40%] h-48 sm:h-56 md:h-64 px-4 sm:px-5 py-4 sm:py-5">
                  <div className="flex flex-col">
                    <div className="flex items-center justify-between gap-x-8 sm:gap-x-12 lg:gap-x-20">
                      <span className="p-2 rounded-full">
                        <svg
                          ...
                          className="lucide lucide-shapes w-6 h-6 sm:w-8 sm:h-8 lg:w-16 lg:h-16 text-lime-400 text-default"
                        >
                      ...
                      <span className="flex flex-col items-start text-lg sm:text-xl lg:text-2xl">
                        <span>STEP</span>
                        <span className="text-lime-400">01</span>
                      </span>
                    </div>
                    <div className="flex flex-col gap-y-3 sm:gap-y-5 mt-3 sm:mt-5">
                      <h3 className="font-semibold text-lg sm:text-xl lg:text-2xl text-white">
                        Planning & Strategy
                      </h3>
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/step1.61292c23.jpg"
              ...
              >
                <img
                  src="https://www.acciobyte.com/_next/static/media/step2.30eb2e49.jpg"
                  alt="Planning & Strategy"
                    ...
                    <div className="flex items-center justify-between gap-x-8 sm:gap-x-12 lg:gap-x-20">
                      <span className="p-2 rounded-full">
                        <svg
                          ...
                          stroke-linecap="round"
                          stroke-linejoin="round"
                          className="lucide lucide-layers w-6 h-6 sm:w-8 sm:h-8 lg:w-16 lg:h-16 text-default"
                        >
              ...
              >
                <div className="flex items-center justify-center bg-[#232323] rounded-2xl w-full lg:w-[40%] h-48 sm:h-56 md:h-64 px-4 sm:px-5 py-4 sm:py-5">
                  <div className="flex flex-col">
                    <div className="flex items-center justify-between gap-x-8 sm:gap-x-12 lg:gap-x-20">
                      <span className="p-2 rounded-full">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-database w-6 h-6 sm:w-8 sm:h-8 lg:w-16 lg:h-16 text-default"><ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M3 5V19A9 3 0 0 0 21 19V5"></path><path d="M3 12A9 3 0 0 0 21 12"></path></svg>
                      </span>
                      <span className="flex flex-col items-start text-lg sm:text-xl lg:text-2xl">
                        <span>STEP</span>
                ...
                <img
                  src="https://www.acciobyte.com/_next/static/media/step3.5fe77aaf.jpg"
                  alt="Planning & Strategy"
                  className="rounded-lg w-full lg:w-[40%] h-48 sm:h-56 md:h-64 object-cover"
                />
              </motion.div>
