      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="uppercase text-[#bff747] font-semibold tracking-wider text-sm">Key Benefits</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-bold text-white leading-tight mb-4">
              Discover the <span className="text-[#bff747]">benefits</span><br />of choosing us today
            </h2>
          </div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          {benefits.map((item, idx) => (
            <div key={idx} className="bg-[#181818] rounded-3xl p-8 flex flex-col shadow-lg hover:shadow-[#bff747]/10 transition-shadow duration-300 min-h-[280px]">
              <div className="text-gray-400 font-bold text-lg mb-4">{item.number}</div>
              <item.icon className="w-9 h-9 text-[#bff747] mb-6" />
