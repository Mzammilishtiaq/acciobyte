  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-[60vh] bg-black overflow-hidden">
      ...
      <div className="absolute left-0 top-0 w-1/2 h-1/2 pointer-events-none" style={{zIndex:0}}>
        <div className="w-full h-full bg-[radial-gradient(circle_at_top_left,_var(--tw-gradient-stops))] from-[#bff747]/30 via-transparent to-transparent"></div>
      </div>
      <div className="relative z-10 flex flex-col items-center w-full">
        <div className="text-white text-center font-bold text-lg mt-8 mb-6 tracking-wide">LETS COLLABORATE</div>
        <div className="relative flex flex-col items-center">
          {/* Green dot above E */}
          <span className="absolute -top-6 left-0 md:left-2 w-3 h-3 bg-[#bff747] rounded-full" style={{marginLeft: '0.25rem'}}></span>
          <div className="flex flex-col items-center">
            ...
            <div className="relative flex justify-center w-full my-2">
              <button className="absolute left-1/2 -translate-x-1/2 -top-8 md:-top-12 bg-[#bff747] text-black rounded-full shadow-lg px-6 py-6 md:px-8 md:py-8 flex flex-col items-center justify-center font-semibold text-xs md:text-base transition hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#bff747]" style={{boxShadow:'0 0 40px 10px #d9ff3e88'}}>
