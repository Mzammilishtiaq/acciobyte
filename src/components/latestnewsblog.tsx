        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="uppercase text-lime-400 font-semibold tracking-wider text-sm">Latest News</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-bold text-white leading-tight mb-4">
              Insights on digital <span className="text-lime-400">innovation</span><br />and growth
            </h2>
          </div>
          <div className="flex-1 flex flex-col items-end justify-start">
            ...
            <span className="block w-4 h-4 bg-lime-400 rounded-full mt-8 mr-8"></span>
          </div>
        </div>
