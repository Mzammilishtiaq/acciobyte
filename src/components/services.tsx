...
export default function Services() {
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-black text-white relative overflow-hidden px-4 lg:px-32">
      {/* Background glow effects */}
      <div className="absolute inset-0">
        <div className="absolute top-20 sm:top-40 left-4 sm:left-20 w-48 h-48 sm:w-96 sm:h-96 bg-[#bff747]/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 sm:bottom-40 right-4 sm:right-20 w-40 h-40 sm:w-80 sm:h-80 bg-[#bff747]/3 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="mb-12 sm:mb-16 md:mb-20">
          <div className="grid gap-8 md:gap-12 items-center md:grid-cols-2">
            <div>
              ...
              >
                Our{" "}
                <span className="text-[#bff747] font-semibold">
                  digital services
                </span>
                <br />
                to grow your brand
            ...
            <div>
              ...
              >
                We help brands communicate to consumers, investors, and their
                teams through our comprehensive digital marketing services.
              </motion.p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-12 sm:mb-20">
          ...
          <motion.div
            ...
            className="group"
          >
            <div className="bg-gray-900/50 border border-gray-800 rounded-3xl p-8 hover:border-[#bff747]/50 transition-all duration-300 hover:bg-gray-800/50 relative">
              <div className="flex items-center justify-between mb-8">
                <div className="w-12 h-12 flex items-center justify-center">
                  <svg viewBox="0 0 24 24" className="w-8 h-8 text-[#bff747]">
                    <path
                ...
                <ArrowUpRight className="h-6 w-6 text-[#bff747] group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-300" />
              </div>
              ...
              <p className="text-gray-400 leading-relaxed text-sm">
                We build responsive, fast, and secure websites tailored to your
                brands needs. Whether its an eCommerce store, a corporate
                website, or a custom web application, we deliver top-notch
                solutions.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-gray-900/50 border border-gray-800 rounded-3xl p-8 hover:border-[#bff747]/50 transition-all duration-300 hover:bg-gray-800/50 relative">
              <div className="flex items-center justify-between mb-8">
                <div className="w-12 h-12 flex items-center justify-center">
                  <div className="w-8 h-8 border-2 border-[#bff747] rounded-full flex items-center justify-center">
                    <div className="flex gap-1">
                      <div className="w-1 h-1 bg-[#bff747] rounded-full"></div>
                      <div className="w-1 h-1 bg-[#bff747] rounded-full"></div>
                    </div>
                  </div>
                </div>
              ...
              <p className="text-gray-400 leading-relaxed text-sm">
                Enhance your online presence with our result-driven digital
                marketing services, including social media management,
                pay-per-click (PPC) advertising, email marketing, and brand
                growth strategies.
              </p>

              <div className="w-2 h-2 bg-[#bff747] rounded-full mt-4"></div>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-gray-900/50 border border-gray-800 rounded-3xl p-8 hover:border-[#bff747]/50 transition-all duration-300 hover:bg-gray-800/50 relative">
              ...
              <p className="text-gray-400 leading-relaxed text-sm">
                Our creative design team provides professional branding, UI/UX
                design, logo design, brochures, and other visuals that make your
          ...
          >
            <div className="bg-gray-900/50 border border-gray-800 rounded-3xl p-8 hover:border-[#bff747]/50 transition-all duration-300 hover:bg-gray-800/50 relative">
              ...
              <p className="text-gray-400 leading-relaxed text-sm">
                Engage your audience with high-quality, SEO-friendly content.
                Our expert writers craft compelling blog posts, website content,
                product descriptions, and marketing copy to boost your brands
                visibility.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-gray-900/50 border border-gray-800 rounded-3xl p-8 hover:border-[#bff747]/50 transition-all duration-300 hover:bg-gray-800/50 relative">
              ...
              <p className="text-gray-400 leading-relaxed text-sm">
                Get found on search engines and increase organic traffic with
                our SEO services, including keyword research, on-page
                optimization, technical SEO, and link-building strategies.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-gray-900/50 border border-gray-800 rounded-3xl p-8 hover:border-[#bff747]/50 transition-all duration-300 hover:bg-gray-800/50 relative">
              ...
              <p className="text-gray-400 leading-relaxed text-sm">
                We offer tailored software solutions to help businesses automate
                workflows, manage data efficiently, and improve operational
        ...
        >
          <div className="border-[20px] border-t-[#bff747] border-l-[#bff747] border-r-[#bff747] border-b-[#bff74721] rounded-3xl lg:py-28 lg:px-16 p-4 md:p-12 bg-gray-900/20">
            <div className="grid gap-8 md:gap-12 items-start md:grid-cols-2">
              <div>
                <h3 className="lg:text-7xl text-3xl md:text-4xl font-normal mb-6 sm:mb-12 leading-tight">
                  Expertise that
                  <br />
                  drives digital
                  <br />
                  <span className="text-[#bff747]">success</span>
                </h3>

                <div className="grid grid-cols-2 gap-4 sm:gap-8">
                  <div>
                    <div className="text-3xl lg:text-6xl md:text-6xl font-bold text-[#bff747] mb-2 sm:mb-4">
                      +60%
                    </div>
              ...
              <div className="space-y-6 sm:space-y-8">
                <div>
                  <div className="flex items-start gap-3 mb-4">
                    <span className="text-[#bff747] text-lg mt-1">✱</span>
                    <h4 className="text-xl lg:text-4xl font-normal text-white">
